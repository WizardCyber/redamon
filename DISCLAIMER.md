...
- **Brute force attacks**: Credential guessing attacks (SSH, FTP, MySQL, SMB, HTTP) can run indefinitely. Users must set appropriate **limits, timeouts, and wordlist sizes** to avoid excessive load on target systems
